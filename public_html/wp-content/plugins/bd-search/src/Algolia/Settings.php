...
class Settings
{
    public function index_settings($index, $algolia_full_index_name)
    {
        // Vars
        $messages = [];
        ...
        $index->setSettings(
            ['searchableAttributes' => $searchableAttributes, 'hitsPerPage' => $hitsPerPage, 'attributesForFaceting' => $attributesForFaceting, 'attributesToSnippet' => $attributesToSnippet, 'ranking' => $ranking],
