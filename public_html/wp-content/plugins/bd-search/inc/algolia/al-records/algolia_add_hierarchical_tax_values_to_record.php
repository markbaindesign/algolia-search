 ...
 */
if (!function_exists('algolia_add_hierarchical_tax_values_to_record')):
   function algolia_add_hierarchical_tax_values_to_record($record, $post_id, $tax)
   {
      ...
      foreach ($terms as $term) {
         ...
         $term_name = $term->name;
         $term_parent = get_term($term->parent, $tax);
         $term_parent_name = $term_parent->name;
         $term_grandparent = get_term($term_parent->parent, $tax);
      ...
      $record[$tax . '-hierarchical'] = $hierarchical_menu_data;
